...
- (BOOL)isSpecialKey:(unsigned short)keyCode {
    ...
    if (keyCode == 122 || keyCode == 120 || keyCode == 99 || keyCode == 118 ||
        keyCode == 96 || keyCode == 97 || keyCode == 98 || keyCode == 100 ||
        keyCode == 101 || keyCode == 109 || keyCode == 111) {
        return YES;
    }
...
- (void)keyDown:(NSEvent *)event {
    ...
    if (displayFlags & NSEventModifierFlagControl) [displayKeys addObject:@"⌃"];
    if (displayFlags & NSEventModifierFlagOption) [displayKeys addObject:@"⌥"];
    if (displayFlags & NSEventModifierFlagShift) [displayKeys addObject:@"⇧"];
    if (displayFlags & NSEventModifierFlagCommand) [displayKeys addObject:@"⌘"];
    if (displayFlags & NSEventModifierFlagFunction) [displayKeys addObject:@"fn"];
    if (displayFlags & NSEventModifierFlagCapsLock) [displayKeys addObject:@"⇪"];
...
- (void)flagsChanged:(NSEvent *)event {
    ...
    if (pressed != 0) {
        ...
        if (flags & NSEventModifierFlagControl) [displayKeys addObject:@"⌃"];
        if (flags & NSEventModifierFlagOption) [displayKeys addObject:@"⌥"];
        if (flags & NSEventModifierFlagShift) [displayKeys addObject:@"⇧"];
        if (flags & NSEventModifierFlagCommand) [displayKeys addObject:@"⌘"];
        if (flags & NSEventModifierFlagFunction) [displayKeys addObject:@"fn"];
        if (flags & NSEventModifierFlagCapsLock) [displayKeys addObject:@"⇪"];
