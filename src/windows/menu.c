...
typedef enum { Default, AllowDark, ForceDark, ForceLight, Max } PreferredAppMode;
...
int menu_show(void) {
    ...
    g_hidden_window =
        CreateWindowExW(0, WINDOW_CLASS_NAME, L"Yakety Menu", 0, 0, 0, 0, 0, NULL, NULL, GetModuleHandle(NULL), NULL);
